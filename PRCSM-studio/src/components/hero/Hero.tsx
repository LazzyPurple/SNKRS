          ...
          <div className="flex flex-col gap-12">
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm mx-auto">
                ...
                />
                <button className="border-2 border-violet-500 text-white bg-transparent hover:bg-violet-500 px-6 py-3 font-mono text-xs uppercase tracking-wider transition-all duration-200 hover:shadow-[4px_4px_0px_0px_rgba(139,92,246,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex justify-center space-x-6">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-500 opacity-70 hover:text-white hover:opacity-100 hover:scale-125 transition-all duration-200"
                >
                  <svg
                    className="w-3 h-3"
                    fill="currentColor"
