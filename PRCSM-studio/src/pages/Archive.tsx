    ...
    <div className="flex-1 w-full bg-prcsm-black text-prcsm-white min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8 border-2 border-white inline-block px-4 py-2 shadow-[4px_4px_0px_0px_#A488EF]">
          <h1 className="font-bold text-2xl uppercase">Archive</h1>
        </div>
        
        {/* Content */}
        <div className="text-center py-20">
          <h2 className="text-4xl font-orbitron font-bold mb-4">ARCHIVE</h2>
          <p className="text-gray-400 text-lg">
            Explorez nos collections passées et pièces d'archives.
          </p>
